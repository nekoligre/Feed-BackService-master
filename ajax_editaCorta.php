...
if(isset($_REQUEST['desc']) && isset($_REQUEST['usu']) && isset($_REQUEST['serv'])){
    ...
    $query = $db->prepare("UPDATE ofrece SET descripcionCorta=? WHERE id_usuario=? and id_servicio=?");
    
    $filasAfectadas=$query->execute(array($_REQUEST['desc'],$_REQUEST['usu'],$_REQUEST['serv']));
